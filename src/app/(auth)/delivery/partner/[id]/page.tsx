...
import { FlipBackward, Truck01 } from "@untitled-ui/icons-react";
import Link from "next/link";

export default async function DeliveryPartnerMethodForm({ params }: { params: Promise<{ id: string }>}) {
        ...
        <div className='main-body'>
            ...
            <div className="flex flex-col gap-[10px]">
                <div className="flex justify-end">
                    <Link href={`/delivery/partner`} className="btn btn-outline-neutral"><FlipBackward />Kembali</Link>
                </div>
