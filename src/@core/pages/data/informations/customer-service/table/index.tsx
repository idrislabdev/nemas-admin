            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>Information Phone</th>
                        <th className='text-center'>Action</th>
                    </tr>
                </thead>
                <tbody>
                    {
                        dataTable.map((item:ICustomerService, index:number) => (
                            <tr key={index}>
                                <td>{index+1}</td>
                                ...
                                <td className='text-center'>
                                    <div className='flex items-center gap-[5px] justify-center'>
                                        <a className='btn-action' onClick={() => deleteData(item.information_customer_service_id)}><TrashOutlineIcon /></a>
                                        <Link href={`/data/informations/customer-service/${item.information_customer_service_id}`} className="btn-action"><PencilOutlineIcon /></Link>
                                    </div>
                                </td>
                            </tr>
                    ))
