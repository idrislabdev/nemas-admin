    ...
    const onSave = async () => {
        ...
        try {
            ...
            if (paramsId == 'form') {
                ...
                const { data } = resp
                if (fileData != null)
                    await uploadFile(data.information_educational_id)
        ...
        <>
            ...
            <div className='form-input'>
                <div className='form-area'>
                    ...
                    <div className='input-area'>
                        <label>
                            Alamat URL {required.information_url && <span className='text-red-500 text-[10px]/[14px] italic'>({required.information_url?.toString()})</span>}
                        </label>
                        <input 
