...
// =====================================================
// Helper konversi index angka ke huruf kolom Excel
// =====================================================
...
const GoldInvestmentTable = () => {
  ...
  const exportData = async () => {
    try {
      ...
      // params.status otomatis ikut di sini
      ...
      const metadata = [
        ...
        {
          cell: 'A6',
          val: `Status: ${params.status || 'Semua'}`,
        },
      ];
