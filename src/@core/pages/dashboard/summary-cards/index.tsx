...
const SummaryCards = () => {
  ...
  return (
    <div className="flex items-center gap-[8px]">
      <div className="w-1/3 flex flex-col justify-between h-[120px] shadow-custom-1 rounded-md p-4">
        <label className="text-xl leading-5 text-green-700 font-semibold line-clamp-2">
          Total Pengguna Aktif
        </label>
        <span className="text-neutral-700 text-[21px]/[23px] font-medium">
