...
import TransferMemberListTable from '@/@core/pages/laporan/transfer-member/table/detail';
import TransferMemberSummaryTable from '@/@core/pages/laporan/transfer-member/table/summary';

const LaporanTransferMemberTablePage = () => {
    ...
    <div className="flex flex-col gap-[20px]">
      <div className="flex items-center gap-[20px]">
        ...
        >
          ...
          <h5 className="font-semibold text-[17px]/[21px]">
            Detail Transfer Member
          </h5>
        </div>
      </div>
      {tabActive === 'detail' && <TransferMemberListTable />}
      {tabActive === 'ringkasan' && <TransferMemberSummaryTable />}
    </div>
  );
};

export default LaporanTransferMemberTablePage;
