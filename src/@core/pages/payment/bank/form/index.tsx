      ...
      <div className="form-input">
        <div className="form-area">
          ...
          <div className="input-area">
            <label>
              Kode Merchant{' '}
              {required.bank_merchant_code && (
                <span className="text-red-500 text-[10px]/[14px] italic">
                  ({required.bank_merchant_code?.toString()})
                </span>
              )}
            </label>
            <input
          ...
          <div className="input-area">
            <label>
              Status Bank{' '}
              {required.bank_active && (
                <span className="text-red-500 text-[10px]/[14px] italic">
                  ({required.bank_active?.toString()})
                </span>
              )}
            </label>
            <select
