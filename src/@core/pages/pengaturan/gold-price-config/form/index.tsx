...
const GoldPriceConfigPageForm = (props: { paramsId: string }) => {
  ...
  const [required, setRequired] = useState<IGoldPriceConfig>(
    {} as IGoldPriceConfig
  );
  ...
  const [goldPriceSettingModelBuyWeekday, setGoldPriceSettingModelBuyWeekday] =
    useState('');
  const [
    goldPriceSettingModelSellWeekday,
    setGoldPriceSettingModelSellWeekday,
  ] = useState('');
  const [goldPriceSettingModelBuyWeekend, setGoldPriceSettingModelBuyWeekend] =
    useState('');
  const [
    goldPriceSettingModelSellWeekend,
  ...
  const onSave = async () => {
    ...
    const body = {
      ...
      gold_price_weight: parseInt(
        goldPriceWeight.toString().replace(/\./g, '')
      ),
  ...
  const fetchData = async () => {
    ...
    setGoldPriceSettingModelBuyWeekday(
      data.gold_price_setting_model_buy_weekday
    );
    setGoldPriceSettingModelSellWeekday(
      data.gold_price_setting_model_sell_weekday
    );
    setGoldPriceSettingModelBuyWeekend(
      data.gold_price_setting_model_buy_weekend
    );
    setGoldPriceSettingModelSellWeekend(
      data.gold_price_setting_model_sell_weekend
    );
      ...
      <div className="flex items-start gap-[10px]">
        <div className="form-area w-1/2">
          ...
          <div className="input-area">
            <label>
              Deskripsi{' '}
              {required.gpc_description && (
                <span className="text-red-500 text-[10px]/[14px] italic">
                  ({required.gpc_description?.toString()})
                </span>
              )}
            </label>
            <input
          ...
          <div className="input-area">
            <label>
              Harga Beli (Hari Kerja){' '}
              {required.gold_price_setting_model_buy_weekday && (
                <span className="text-red-500 text-[10px]/[14px] italic">
                  ({required.gold_price_setting_model_buy_weekday?.toString()})
                </span>
              )}
            </label>
            <input
              ...
              onChange={(e) =>
                setGoldPriceSettingModelBuyWeekday(e.target.value)
              }
              className={`base ${
                required.gold_price_setting_model_buy_weekday ? 'error' : ''
              }`}
            />
          </div>
          <div className="input-area">
            <label>
              Harga Jual (Hari Kerja){' '}
              {required.gold_price_setting_model_sell_weekday && (
                <span className="text-red-500 text-[10px]/[14px] italic">
                  ({required.gold_price_setting_model_sell_weekday?.toString()})
                </span>
              )}
            </label>
            <input
              ...
              onChange={(e) =>
                setGoldPriceSettingModelSellWeekday(e.target.value)
              }
              className={`base ${
                required.gold_price_setting_model_sell_weekday ? 'error' : ''
              }`}
            />
          </div>
        </div>
        <div className="form-area  w-1/2">
          <div className="input-area">
            <label>
              Harga Beli (Hari Libur){' '}
              {required.gold_price_setting_model_buy_weekend && (
                <span className="text-red-500 text-[10px]/[14px] italic">
                  ({required.gold_price_setting_model_buy_weekend?.toString()})
                </span>
              )}
            </label>
            <input
              ...
              onChange={(e) =>
                setGoldPriceSettingModelBuyWeekend(e.target.value)
              }
              className={`base ${
                required.gold_price_setting_model_buy_weekend ? 'error' : ''
              }`}
            />
          </div>
          <div className="input-area">
            <label>
              Harga Jual (Hari Libur){' '}
              {required.gold_price_setting_model_sell_weekend && (
                <span className="text-red-500 text-[10px]/[14px] italic">
                  ({required.gold_price_setting_model_sell_weekend?.toString()})
                </span>
              )}
            </label>
            <input
              ...
              onChange={(e) =>
                setGoldPriceSettingModelSellWeekend(e.target.value)
              }
              className={`base ${
                required.gold_price_setting_model_sell_weekend ? 'error' : ''
              }`}
            />
          </div>
          <div className="input-area">
            <label>
              ...
              {required.gpc_active && (
                <span className="text-red-500 text-[10px]/[14px] italic">
                  ({required.gpc_active?.toString()})
                </span>
              )}
            </label>
            <select
              className="base"
              defaultValue={gpcActive}
