...
import GoldSellSummaryUserTable from '@/@core/pages/laporan/gold-sell/table/summary';
import GoldSellTransactionDetailsTable from '@/@core/pages/laporan/gold-sell/table/detail';

const LaporanGoldSellDigitalPage = () => {
    ...
    <div className="flex flex-col gap-[20px]">
      <div className="flex items-center gap-[20px]">
        ...
        >
          ...
          <h5 className="font-semibold text-[17px]/[21px]">Detail Penjualan</h5>
        </div>
        <div
          className={`flex items-center gap-[8px] rounded w-1/2 border px-[20px] py-[10px] cursor-pointer ${
            tabActive === 'ringkasan'
      ...
      {tabActive === 'detail' && <GoldSellTransactionDetailsTable />}
      {tabActive === 'ringkasan' && <GoldSellSummaryUserTable />}
    </div>
  );
};

export default LaporanGoldSellDigitalPage;
