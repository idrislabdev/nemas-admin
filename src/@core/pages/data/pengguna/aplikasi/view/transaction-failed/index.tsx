...
const ProfileTransactionFailed = (props: { id: string }) => {
  const { id } = props;
  ...
  const fetchData = useCallback(async () => {
    ...
    const resp = await axiosInstance.get(
      `/reports/gold-transactions/?transaction_status=fail&user_id=${id}&fetch=${params.limit}&offset=${params.offset}${filterString}&order_by=transaction_date&order_direction=ASC`
    );
...
export default ProfileTransactionFailed;
