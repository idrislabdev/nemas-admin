...
import DeliveryPartnerServicePageTable from "@/@core/pages/delivery/partner/service/table";
import { Truck01 } from "@untitled-ui/icons-react";

export default async  function DeliveryPartnerPage({ params }: { params: Promise<{ id: string }>}) {
      ...
      <div className='container-body'>
        ...
        <div className='main-body'>
            ...
            <div className="flex flex-col gap-[10px]">
                <DeliveryPartnerServicePageTable paramsId={paramsId} />
            </div>
        </div>
      </div>
    </div>
