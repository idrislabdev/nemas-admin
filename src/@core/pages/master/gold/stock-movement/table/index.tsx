...
const GoldStockMovementPageTable = () => {
  ...
  const columns: ColumnsType<IGoldStockMovement> = [
    ...
    },
    {
      ...
      render: (_, record) =>
        `${formatterNumber(
          parseFloat(record.weight ? record.weight.toString() : '')
        )} gr`,
    },
    {
      ...
      render: (_, record) =>
        `${formatterNumber(
          parseFloat(record.stock_before ? record.stock_before.toString() : '')
        )} gr`,
    },
    {
      ...
      render: (_, record) =>
        `${formatterNumber(
          parseFloat(record.stock_after ? record.stock_after.toString() : '')
        )} gr`,
    },
