...
const GoldCertDetailPageTable = () => {
    ...
    const columns: ColumnsType<IGoldCertPriceDetail>  = [
        ...
        { title: 'Kode Sertifikat', dataIndex: 'gold_cert_code', key: 'gold_cert_code'},
        ...
        { title: 'Include Stock', dataIndex: 'include_stock', key: 'include_stock',
            render: (_, record) => (`${record.include_stock ? 'Ya' : 'Tidak'}`) 
        },
        { title: '', key: 'action', fixed: 'right', width:100,
          render: (_, record) =>
          (<div className='flex items-center gap-[5px] justify-center'>
            <Link href={`/master/gold/cert-price-detail/${record.id}`} className="btn-action"><Edit05 /></Link>
       ...
       <>
            ...
            <div className='flex items-center justify-between'>
                ...
                <div className='flex items-center gap-[4px]'>
                    ...
                    <Link href={`/master/gold/cert-price-detail/form`} className="btn btn-outline-neutral"><Plus />Add data</Link>
                </div>
            </div>
